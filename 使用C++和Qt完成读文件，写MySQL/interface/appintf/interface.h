...
// 2007/09/20 增加 bayid 的检索条件 本次修改均以 zzg 0920 注释
...
//#define ANALOG_QUERYINFO_BAYID		"BayID"                     
...
//#define ANALOGSTAT_QUERYINFO_BAYID		"BayID"                     
...
//#define STATUS_QUERYINFO_BAYID		"BayID"                     
...
//#define STATUSSTAT_QUERYINFO_BAYID		"BayID"                     
...
//#define PULSE_QUERYINFO_BAYID		"BayID"                     
...
//#define PULSESTAT_QUERYINFO_BAYID		"BayID"                     

#define ALARM_QUERY							"AlarmQuery"
#define ALARM_QUERYINFO_BALARMTYPE			"bAlarmType"  //是否按报警类型
#define ALARM_QUERYINFO_ALARMTYPEID			"AlarmTypeID"  //报警类型ID
#define ALARM_QUERYINFO_TASKTYPEID          "TaskTypeID" //业务类型ID
#define ALARM_QUERYINFO_LEVEL               "AlarmLevel" //报警等级  
#define ALARM_QUERYINFO_STARTTIME			"StartTime"  //起始时间
#define ALARM_QUERYINFO_ENDTIME				"EndTime"    //结束时间
#define ALARM_QUERYINFO_BAYID		        "BayID"      //按间隔
#define ALARM_QUERYINFO_STATIONID		    "StationID"  //按厂站
#define ALARM_QUERYINFO_OPERATOR            "Operator"   //告警操作人                
#define ALARM_QUERYINFO_FILTER				"Filter"     //告警描述字符串模糊查询                 

#define ALARM_BRIFE							"AlarmBrife"
#define ALARM_BRIFE_QUERYINFO_ALARMTYPEID			"AlarmTypeID"  //报警类型ID
#define ALARM_BRIFE_QUERYINFO_TASKTYPEID          "TaskTypeID" //业务类型ID
#define ALARM_BRIFE_QUERYINFO_STARTTIME			"StartTime"  //起始时间
#define ALARM_BRIFE_QUERYINFO_ENDTIME				"EndTime"    //结束时间
#define ALARM_BRIFE_QUERYINFO_BAYID		        "BayID"      //按间隔
#define ALARM_BRIFE_QUERYINFO_STATIONID		    "StationID"  //按厂站
#define ALARM_BRIFE_QUERYINFO_OPERATOR            "Operator"   //告警操作人                  
...
//#define FAULTINFO_QUERYINFO_BAYID		"BayID"                    //zzg 0920
...
//#define FAULTANALOG_QUERYINFO_BAYID		"BayID"                    //zzg 0920

//错误返回码
#define QUERY_SUCCESS_PART	1		//部分成功
#define QUERY_SUCCESS		0		//查询全部记录成功		
...
#define ALARM_AlarmTime 0
#define ALARM_AlarmTypeID 1
#define ALARM_TASKTYPEID 2
#define ALARM_Description 3
#define ALARM_EmitTime 4
#define ALARM_OBJID 5
#define ALARM_ALARMVALUE 6
#define ALARM_ALARMLEVEL 7  //add by weixing
#define ALARM_BAYID 8
#define ALARM_OBJTYPE 9

#define BRIFE_ID 0
#define BRIFE_BAYID 1
#define BRIFE_STATION 2
#define BRIFE_BAYDISC 3
#define BRIFE_IEDDISC 4
#define BRIFE_REPORTTIME 5
#define BRIFE_RPTREASION 6
#define BRIFE_RPTEVENT 7
#define BRIFE_RELATEMSG 8
#define BRIFE_DEALMSG 9
#define BRIFE_REAERVE 10  //add by 牛津文
...
#define IID_IICSHisAccessEx			"IICSHisAccessEx"
...
struct THisAlarm
{
	...
	int		nValue;
	QString	sDesccrion;
	void Init(){sAlarmTime=sEmitTime=sObjName=sObjType=sDesccrion="";
	nTaskTypeID=nTypeID=nStationID=nBayID=nLevel=nAction=nValue=0;}
};

class IICSHisAccessEx : public IICSHisAccess
{
public:
	// 新增历史告警信息
	virtual bool AddAlarm(const THisAlarm& tHisAlarm) = 0;
	// 删除历史告警信息
	virtual bool DelAlarm(int objID, const QString& sType, const QString& sAlarmTime) = 0;
	// 修改历史告警信息
	virtual bool UpdateAlarm(const QString& sNewDesc, int objID, const QString& sObjType, const QString& sAlarmTime) = 0;
};
