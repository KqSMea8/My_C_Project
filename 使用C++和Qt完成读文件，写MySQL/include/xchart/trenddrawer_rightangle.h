#ifndef _TREND_DRAWER_RIGHTANGLECURVE_H_INCLUDED_
#define _TREND_DRAWER_RIGHTANGLECURVE_H_INCLUDED_
 ...
 *	直角折线模式绘制类
 */
class HMITRENDOBJ_EXPORT TrendDrawerRightAngle : public TrendDrawer
{
public:
	TrendDrawerRightAngle(Trend* pTrend, const char* name=0);
	~TrendDrawerRightAngle();
...
#endif	//_TREND_DRAWER_RIGHTANGLECURVE_H_INCLUDED_