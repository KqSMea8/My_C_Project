...
#ifndef _TASKMODELLIB_2008_6_17_PENGSHIKANG_H_
#define _TASKMODELLIB_2008_6_17_PENGSHIKANG_H_
...
public:
	CICSSettings() : CIntfObjPtrA<IICSSettings>(MODULE_ICSSettings)
	{
		...
		if(m_pObj) m_pObj->AddRef();//因为icssettings模块不能释放，故添加此句！彭世康--20160919
	}
};
