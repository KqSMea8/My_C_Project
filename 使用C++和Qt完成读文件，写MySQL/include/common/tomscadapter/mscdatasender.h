//mscdatasender.h                                  // for CMscDataSender

#ifndef _MSCDATASENDER_PENGSHIKANG_2011_08_09_H_
#define _MSCDATASENDER_PENGSHIKANG_2011_08_09_H_
...
//消息数据通过消息中心往其他服务程序发送
class CMscDataSender
{
public:
	CMscDataSender(bool toCenter, MSC_MSGT msgClass)
	{
		if(toCenter)
			m_nReceiverType = static_cast<long>(MSC_PTYPE_INTERSITE);//intersite
		else
